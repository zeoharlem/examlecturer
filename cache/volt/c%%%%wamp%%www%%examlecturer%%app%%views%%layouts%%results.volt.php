    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                Load Courses | <strong>upload results</strong>
            </header>
            <div class="panel-body">
                <div class="position-left">
                    <form class="form-inline" method="post" action="<?= $this->url->get('results/show') ?>" role="form">
                    <div class="form-group">
                        
                        <select class="form-control input-lg" name="code">
                            <?php foreach ($depts as $keys => $values) { ?>
                            <option value="<?= $values->code ?>"><?= ucwords($values->title) ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="form-group">
