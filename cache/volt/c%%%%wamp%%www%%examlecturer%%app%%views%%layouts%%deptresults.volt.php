        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-left">
                    <form class="form-inline" method="post" target="_blank" action="<?php echo $this->url->get('collectivegrade/collective'); ?>" role="form">
                    <div class="form-group">
                        <input type="hidden" value="<?php echo $this->session->get('hod')['hoddept']; ?>" name="department" />
