        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-left">
                    <form class="form-inline" method="post" action="<?php echo $this->url->get('carryover/getCarryOver'); ?>" role="form">
                    <div class="form-group">
                        <select class="form-control input-lg" name="code" style="font-size:13px;">
                            <?php foreach ($courses as $keys => $values) { ?>
                                <option value="<?php echo $values->code; ?>" style="font-size:13px;"><?php echo ucwords($values->title); ?></option>
                            <?php } ?>
                        </select>
