...
class BaseModel extends \Phalcon\Mvc\Model{
    ...
    public static function __getBMInst(){
        if(!self::$_instance instanceof BaseModel){
     ...
     * @author Theophilus Alamu <zeoharlem@yahoo.co.uk>
     */
    public function __postIntKeyRaw(array $arrays, $table, 
            $others='',$action = self::MODEL_INSERT){
        foreach($arrays as $keys => $values){
            $sqlState = $action." INTO $table SET ";
