    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li><a href="{{url('students')}}"><i class="fa fa-graduation-cap"></i><span>View Students</span></a></li>
                <li class="active"><a href="{{url('courseregistration/download')}}"><i class="fa fa-file-excel-o"></i><span>Download Registered Courses</span></a></li>
                <li><a href="{{url('carryover/')}}"><i class="fa fa-street-view"></i><span>Carry Over Registration</span></a></li>
                
                <li class="active"><a href="{{url('results')}}"><i class="fa fa-cubes"></i><span>Upload Results</span></a></li>
                <li class="active"><a href="{{url('results/viewForm')}}"><i class="fa fa-desktop"></i><span>Check Results</span></a></li>
                <?php  if($this->session->get('hod')){ ?>
                <li class="active"><a href="{{url('departmentResults/')}}"><i class="fa fa-user-plus"></i><span>Department Results</span></a></li>
                <?php } ?>
                <li><a href="{{url('carryover/')}}"><i class="fa fa-paper-plane-o"></i><span>Carry Over Upload</span></a></li>
                <li>
                    <a href="{{url('')}}">
